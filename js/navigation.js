...
function toggleSearchBar (item, searchElement, className, focusInput) {
...
const inputField = document.querySelector('.wp-block-search__input');
...
// const searchX = document.querySelector('.widget_block');
